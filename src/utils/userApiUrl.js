...
// 인바디 정보 저장
export const POST_INBODY_URL = (user_number) => `${url}/inbody/${user_number}`;

// 특정 사용자 페이지 정보 조회
export const GET_USER_URL = (user_number) => `${url}/page/${user_number}`;

// 특정 사용자의 인바디 정보 조회
export const GET_USER_INBODY_URL = (user_number) =>
